...
public class P2PFileProcess {
    ...
    final static int LOG_CONNECTTO = 1;
    final static int LOG_CONNECTFROM = 2;
    final static int LOG_PREFER = 3;
    final static int LOG_OPTIMISTIC = 4;
    final static int LOG_UNCHOKING = 5;
    final static int LOG_CHOKING = 6;
    final static int LOG_HAVE = 7;
    final static int LOG_INTEREST = 8;
    final static int LOG_NOTINTEREST = 9;
    final static int LOG_DOWNLOAD = 10;
    final static int LOG_COMPLETE = 11;
